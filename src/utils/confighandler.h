...
public:
    ...
    CONFIG_GETTER_SETTER(ftpUrl, setFtpUrl, QString)
    CONFIG_GETTER_SETTER(ftpRemotePath, setFtpRemotePath, QString)
    CONFIG_GETTER_SETTER(ftpPort, setFtpPort, int)
    CONFIG_GETTER_SETTER(ftpUsername, setFtpUsername, QString)
